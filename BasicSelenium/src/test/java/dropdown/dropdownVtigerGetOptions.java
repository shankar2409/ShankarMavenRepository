...
public class dropdownVtigerGetOptions {
...
//		List<WebElement> options=driver.findElements(By.xpath("//select[@name='industry]//option"));
...
//		}
		...
		int count=1;
		for(WebElement r:option)
  		{
			if(r.getText().equalsIgnoreCase("education"))
			{
				r.click();
			}
			System.out.println(count+"st element  :"+r.getText());
			count++;
		}
		
		System.out.println("dropdown list "+count+"  present");
	}
}
